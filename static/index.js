...
for (var i = 0; i < elements.length; i++) {
    ...
    elements[i].addEventListener('dragstart', (ev) => { drag(ev) })
}
var elements = document.getElementsByClassName('dbclickbox');
for (var i = 0; i < elements.length; i++) {
    elements[i].addEventListener('dbclick', (ev) => { showpopup(ev) })
}
